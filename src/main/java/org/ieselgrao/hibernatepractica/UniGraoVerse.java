package org.ieselgrao.hibernatepractica;
...
public class UniGraoVerse extends Application {
     ...
     * Project's title.
     */
    private final static String TITLE = "UniGraoVerse | 2026";
     ...
     */
    public static UniGraoVerse main;
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        stage.setTitle(UniGraoVerse.TITLE);
        goScene("main");
    }
    ...
    public void goScene(String view) throws IOException {
        ...
        try{
            URL resource = UniGraoVerse.class.getResource("/fxml/"+view+".fxml");
            if(resource == null){
                throw new Exception();
            }
